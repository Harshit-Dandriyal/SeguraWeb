...
const ThreeColumn = () => (
    <div class="Three">
        ...
        <div className="Column">
        <span>SEGURA HUNT</span>
        <div className="Content">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ullam sit quos exercitationem quod fugiat architecto</div>
        </div>
        <div className="Column">
